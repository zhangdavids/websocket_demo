...
class TradeApi(object):
    ...
    def quantPlaceOrder(self, amount, symbol, direction, price):
        """量化下单"""
        path = '/v1/order/inner/create'
    ...
    def batchPlaceOrder(self, accountid, symbol, prices, source=None):
        """批量下单"""
        path = '/v1/order/batchcreate'
